        ...
        if (window.React && window.ReactDOM) {
            ...
            if (roadmapRoot) {
                ...
                setTimeout(() => {
                    ...
                    const lineMain = document.querySelector('.phases__box__content__line__second');
                        ...
                        entries.forEach(entry => {
                            if (entry.isIntersecting) {
                                ...
                                if (animClass) {
                                    ...
                                    if (lineMain) {
                                        lineMain.style.animation = `lineProgress 2s ease-out forwards`;
                                    }
                                    if (lineEllipse) {
                                        lineEllipse.style.animation = `ellipseMove 2s ease-out forwards`;
                                    }
                                }
                            }
                        });
