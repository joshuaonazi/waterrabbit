        ...
        if (window.React && window.ReactDOM) {
            ...
            if (roadmapRoot) {
                ...
                // Scroll-triggered animations for roadmap
                setTimeout(() => {
                    const roadmapBox = document.querySelector('.phases__box');
                    if (!roadmapBox) return;
                    
                    const roadmapSection = document.querySelector('.phases.landing-section');
                    ...
                    // Intersection observer for viewport-based animation triggering
                    const animObserver = new IntersectionObserver((entries) => {
                        entries.forEach(entry => {
                            if (entry.isIntersecting && !animationsTriggered) {
                                ...
                                if (lineSecond) {
                                    lineSecond.style.animation = `lineProgress 2s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s forwards`;
                                }
                                if (lineEllipse) {
                                    lineEllipse.style.animation = `ellipseMove 2s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s forwards`;
                                }
                                
                                // Stop observing after animations trigger
                    ...
                    if (roadmapSection) {
                        animObserver.observe(roadmapSection);
                    }
                }, 100);
            }
        }
